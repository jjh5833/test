                    ...
                    <div class="title-wrap">
                        ...
                        @guest
                            <div class="col-50" style="width: 300px; float: right ">
                                <div class="title-wrap" style="border: 1px" ; w>
                                    <x-auth-card>
                                        <x-slot name="logo">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="flex items-center justify-end mt">
                                                ...
                                                <a class="nav-link" href="{{url('/')}}/register" style="width: 100px">회원가입</a>
        ...
        <div>
            ...
            <div id="imgbox">
                <div id ="1" style="display:none; z-index:1;">
                    <h2>서울</h2>
                    <img src="./image/seoulSMT 서울 남산타워.jfif" height="200px">
